...
const miniGames = [
  ...
  },
  {
    ...
    title: "Караоке числительных",
    description: "Музыкальная тренировка по склонению числительных: памятки, караоке форм и 20 упражнений в демо-версии.",
    button: "Демо",
    path: "/games/karaoke-numerals/index.html",
    demo: true,
    demoNotice: "В демо доступны памятки, караоке форм и 20 упражнений. Полная версия с расширенной практикой и текстами открывается после покупки.",
    category: "speech",
    categoryTitle: "Культура речи",
    kindLabel: "игра",
  },
  ...
  },
  {
    ...
    title: "Бар добавочных действий",
    description: "Летний квест по деепричастному обороту: рецепты напитков, пунктуационные задания и финальная тренировка.",
    button: "Играть",
    path: "/games/summer-gerund-bar/index.html",
    category: "syntax",
    categoryTitle: "Синтаксис и пунктуация",
    kindLabel: "мини-игра",
  },
