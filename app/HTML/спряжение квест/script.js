...
const EXTRA_TASKS = [
  ...
  { id: "ege12u_0046", variant: "(они) топч..т (траву)", answer: "у", correct_letter: "у", correct_spelling: "(они) топчут (траву)", explanation: "Топтать относится ко I спряжению в этой форме." },
